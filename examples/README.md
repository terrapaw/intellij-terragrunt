...
Focused example projects demonstrating plugin features. Open any subdirectory in IntelliJ with the plugin installed.

| Directory | Demonstrates |
|---|---|
| `basic/` | Locals, dependencies, inputs, navigation, rename |
